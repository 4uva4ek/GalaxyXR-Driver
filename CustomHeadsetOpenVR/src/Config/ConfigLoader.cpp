...
void ConfigLoader::ParseConfig(){
	...
	try{
		...
		if(data["galaxyXr"].is_object()){
			...
			// 2026-09-19 SDR10 baseline: opt-in neutral baseline (effective,
			// not stored: SdrColorPolicy.h). missing = false, invalid types
			// ignored — the existing parser convention, no migration.
