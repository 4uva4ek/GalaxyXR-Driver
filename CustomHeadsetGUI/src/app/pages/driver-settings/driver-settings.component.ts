...
@Component({selector:'app-driver-settings', imports:[CommonModule,FormsModule,RouterLink,MatSlideToggleModule,MatSliderModule,MatSelectModule,MatButtonModule,MatIconModule,MatInputModule,FieldTipComponent,ResetButtonComponent,StreamFrameCurveComponent,DriverEnableBannerComponent,SystemReadyComponent], templateUrl:'./driver-settings.component.html', styleUrl:'../galaxy-settings/galaxy-settings.scss'})
export class DriverSettingsComponent extends GalaxySettingsBase {}
