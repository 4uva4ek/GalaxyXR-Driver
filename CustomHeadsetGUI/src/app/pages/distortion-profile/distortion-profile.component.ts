...
@Component({selector:'app-distortion-profile', imports:[CommonModule,FormsModule,RouterLink,MatSlideToggleModule,MatSliderModule,MatSelectModule,MatButtonModule,MatIconModule,MatInputModule,FieldTipComponent,ResetButtonComponent,StreamFrameCurveComponent,DriverEnableBannerComponent,SystemReadyComponent], templateUrl:'./distortion-profile.component.html', styleUrl:'../galaxy-settings/galaxy-settings.scss'})
export class DistortionProfileComponent extends GalaxySettingsBase {}
