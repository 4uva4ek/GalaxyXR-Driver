...
export class AppComponent {
  ...
  constructor(appSettingService: AppSettingService, public appUpdateService: AppUpdateService, public sds: SystemDiagnosticService, @Inject(DOCUMENT) document: Document) {
    effect(() => {
