// Vendor-aware config paths, ported from src/app/services/paths.service.ts.
// Must mirror ConfigLoader::GetConfigFolder in the driver: vendor builds keep
// their config in a separate folder from the vendor-neutral driver.
