...
// Keep the Cargo binary name/target directory unchanged. Portable staging
// publishes it as Galaxy XR Companion.exe; Rust modules and existing paths
// must not be renamed as part of a cosmetic branding change.
